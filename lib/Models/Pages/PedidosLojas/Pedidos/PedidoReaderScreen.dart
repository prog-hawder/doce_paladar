...
class PedidoReaderScreen extends StatefulWidget {
  PedidoReaderScreen(this.doc, {Key? key}) : super(key: key);
  QueryDocumentSnapshot doc;

  @override
  State<PedidoReaderScreen> createState() => _PedidoReaderScreenState();
}

class _PedidoReaderScreenState extends State<PedidoReaderScreen> {
                          ...
                          Expanded(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: AssetImage(
                                          _SalgadosMiniList[index].salgadoImg),
                                      fit: BoxFit.cover),
                                ),
                                child: null,
                              )),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      children: [
                                        Text(_SalgadosMiniList[index].salgadoName,
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontWeight: FontWeight.bold,
                                                fontSize: 18,
                                        ...
                                        Text(_SalgadosMiniList[index].salgadoPct,
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontWeight: FontWeight.normal,
                                                fontSize: 14,
